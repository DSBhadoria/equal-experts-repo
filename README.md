...
* When you have completed the assignment, you need to  push your code to this repository and [mark the assignment as completed by clicking here](https://app.snapcode.review/submission_links/0adc5298-2b2e-46e8-9ac1-eb84a02c2201).
...
## Steps to Dockerize
docker build -t githubgistsapi .

docker run -p 8080:8080 githubgistsapi

## How to Access
http://localhost:8080/user?per_page=100&page=0

http://localhost:8080/user?per_page=100
